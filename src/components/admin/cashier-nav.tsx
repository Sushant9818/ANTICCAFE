...
const navItems = [{ href: "/cashier/orders", label: "Orders", icon: Receipt }];

export function CashierNav() {
  const pathname = usePathname();

  return (
    <aside className="print:hidden w-56 bg-admin-ink text-stone-400 flex flex-col shrink-0 min-h-screen">
