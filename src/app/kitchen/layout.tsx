import { KitchenNav } from "@/components/admin/kitchen-nav";
...
export const metadata: Metadata = {
  title: "Kitchen — AnticCafe",
};

export default function KitchenStaffLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
