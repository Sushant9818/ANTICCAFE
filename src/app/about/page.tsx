...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      <h1 className="text-4xl font-bold text-stone-900 mb-4">{CAFE_NAME}</h1>
      ...
      <div className="prose prose-stone max-w-none mb-12">
        <h2 className="text-2xl font-bold text-stone-900 mb-3">Our Story</h2>
        ...
        <ul className="space-y-2 text-stone-600 mb-6 list-none pl-0">
          {[
      ...
      <div className="bg-amber-50 rounded-2xl p-8">
        <h2 className="text-xl font-bold text-stone-900 mb-4">Find Us</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-stone-700">
          ...
          <div>
            ...
            <a href={`tel:${CAFE_PHONE}`} className="hover:text-amber-700 transition-colors">
              {CAFE_PHONE}
            </a>
          </div>
          <div>
            <p className="font-semibold mb-1">Weekdays</p>
            <p>{CAFE_HOURS.weekdays}</p>
          </div>
          <div>
            <p className="font-semibold mb-1">Weekends</p>
